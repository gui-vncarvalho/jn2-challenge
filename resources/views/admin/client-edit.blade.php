                    ...
                    <div class="flex flex-wrap">
                        ...
                        <div class="p-2 w-1/2">
                            <div class="relative">
                                ...
                                <input value="{{ old('phone', $client->phone) }}" type="tel" id="phone" name="phone" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                            </div>
                            @error('phone')
                                <div class="text-red-400 text-sm">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="p-2 w-1/2">
                            <div class="relative">
                                ...
                                <input value="{{ old('plate', $client->plate) }}" type="text" id="plate" name="plate" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                            </div>
                            @error('plate')
                                <div class="text-red-400 text-sm">{{ $message }}</div>
                            @enderror
